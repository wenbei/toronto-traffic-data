...
<div>
  <form on:submit|preventDefault={search} class="flex">
    <input bind:value={searchAddress} class="h-8 max-w-lg flex-grow border-2 border-gray-300" />
    <button type="submit" class="mx-2 rounded bg-gray-300 px-2">Search</button>
  </form>
