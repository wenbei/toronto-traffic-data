...
<div class="relative grid grid-cols-2 grid-rows-2 aspect-square min-w-[250px]">
  ...
  <div class="flex flex-col-reverse outline outline-1 gap-2 p-1">
    <div class="flex flex-row-reverse">
      ...
      <span class="vertical">🡼 {volumes.sb_cars_r + volumes.sb_truck_r + volumes.sb_bus_r}</span>
    </div>
    <div class="flex flex-row-reverse">
  ...
  <div class="flex outline outline-1 gap-2 p-1">
    <div class="flex flex-col-reverse">
      ...
      <span>🡼 {volumes.wb_cars_r + volumes.wb_truck_r + volumes.wb_bus_r}</span>
    </div>
    <div class="flex flex-col-reverse">
  ...
  <div class="flex flex-row-reverse outline outline-1 gap-2 p-1">
    <div class="flex flex-col text-right">
      ...
      <span>{volumes.eb_cars_r + volumes.eb_truck_r + volumes.eb_bus_r} 🡾</span>
    </div>
    <div class="flex flex-col text-right">
  ...
  <div class="flex flex-col outline outline-1 gap-2 p-1">
    <div class="flex text-right">
      ...
      <span class="vertical">{volumes.nb_cars_r + volumes.nb_truck_r + volumes.nb_bus_r} 🡾</span>
    </div>
    <div class="flex text-right">
